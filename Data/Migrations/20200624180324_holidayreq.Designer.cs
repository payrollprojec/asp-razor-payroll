...
namespace PayrollAppRazorPages.Data.Migrations
{
    ...
    [Migration("20200624180324_holidayreq")]
    partial class holidayreq
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayrollAppRazorPages.Models.GlobalSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayrollAppRazorPages.Models.StaffSalaryExtra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayrollAppRazorPages.Models.StaffSalaryExtra", b =>
                {
                    b.HasOne("PayrollAppRazorPages.Models.SalaryItem", "SalaryItem")
                        .WithMany()
                        .HasForeignKey("SalaryItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayrollAppRazorPages.Models.StaffSalary", "StaffSalary")
                        .WithMany("StaffSalaryExtras")
